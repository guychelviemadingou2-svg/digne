        ...
        <div class="form-card">
            <form method="POST" action="/categories">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Ex: Électronique, Vêtements, Alimentation..." value="{{ old('name') }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" placeholder="Décrivez cette catégorie (couleur, type de produits, etc.)">{{ old('description') }}</textarea>
                    @error('description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="info-box">
                    <strong>💡 Conseil:</strong> Utilisez des noms clairs et courts. Les catégories aident à organiser et filtrer votre inventaire rapidement.
                </div>
